...
01788 \}
01789 
01790 \textcolor{keywordtype}{int} LMS7_Device::MCU_AGCStart(uint32\_t wantedRSSI)
01791 \{
01792     lime::MCU_BD *mcu = lms_list.at(lms_chip_id)->GetMCUControls();
01793     lms_list.at(lms_chip_id)->Modify\_SPI\_Reg\_bits(0x0006, 0, 0, 0);
01794 
01795     uint8\_t mcuID = mcu->ReadMCUProgramID();
01796     lime::debug(\textcolor{stringliteral}{"Current MCU firmware: %i, expected %i"}, mcuID, 
      MCU_ID_CALIBRATIONS_SINGLE_IMAGE);
01797     \textcolor{keywordflow}{if}(mcuID != MCU_ID_CALIBRATIONS_SINGLE_IMAGE)
01798     \{
01799         lime::debug(\textcolor{stringliteral}{"Uploading MCU AGC firmware"});
01800         \textcolor{keywordtype}{int} status = mcu->Program_MCU(mcu_program_lms7_dc_iq_calibration_bin, 
      lime::IConnection::MCU\_PROG\_MODE::SRAM);
01801         lime::info(\textcolor{stringliteral}{"MCU AGC firmware uploaded"});
01802         \textcolor{keywordflow}{if}(status != 0)
01803             \textcolor{keywordflow}{return} status;
01804     \}
01805 
01806     \textcolor{keywordtype}{long} refClk = lms_list.at(lms_chip_id)->GetReferenceClk\_SX(\textcolor{keyword}{false});
01807     mcu->SetParameter(MCU_BD::MCU_REF_CLK, refClk);
01808 
01809     lms_list.at(lms_chip_id)->Modify\_SPI\_Reg\_bits(0x002D, 15, 0, wantedRSSI >> 2);
01810     mcu->RunProcedure(MCU_FUNCTION_AGC);
01811     \textcolor{keywordflow}{return} 0;
01812 \}
01813 
01814 \textcolor{keywordtype}{int} LMS7_Device::MCU_AGCStop()
01815 \{
01816     lime::MCU_BD *mcu = lms_list.at(lms_chip_id)->GetMCUControls();
01817     mcu->RunProcedure(0);
01818     lms_list.at(lms_chip_id)->Modify\_SPI\_Reg\_bits(0x0006, 0, 0, 0);
01819     \textcolor{keywordflow}{return} 0;
01820 \}
01821 
01822 \}\textcolor{comment}{//namespace lime}
\end{DoxyCode}
