...
00469 
00470             \textcolor{keywordflow}{if} (metadata.droppedPackets) ret = SOAPY_SDR_TIME_ERROR;
00471             \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (metadata.overrun) ret = SOAPY_SDR_OVERFLOW;
00472             \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (metadata.underrun) ret = SOAPY_SDR_UNDERFLOW;
00473         \}
...
00478             \textcolor{keywordflow}{return} SOAPY_SDR_TIMEOUT;
...
00488     flags |= SOAPY_SDR_HAS_TIME;
